declare const styles: {
  ...
  readonly "select-arrow-up": string;
  readonly "select-clear": string;
  readonly "select-container": string;
  readonly "select-field": string;
  readonly "select-field-container": string;
  readonly "select-field-selector": string;
